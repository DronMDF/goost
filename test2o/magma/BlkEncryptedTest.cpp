	...
	: tests(
		make_unique<TestNamed>(
			...
			make_shared<const TestNamed>(
				...
				make_shared<TestBlockEqual>(
					make_shared<BlkEncrypted>(
						BlkRaw(0x0001020304050607),
						make_shared<Key>(
							vector<uint32_t>{
								0xE0F67504, 0xFAFB3850,
								0x90C3C7D2, 0x3DCAB3ED,
								0x42124715, 0x8A1EAE91,
								0x9ECD792F, 0xBDEFBCD2
							},
